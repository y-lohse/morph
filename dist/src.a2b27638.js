...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/svg.js/dist/svg.js":[function(require,module,exports) {
var define;
/*!
...
},{"./_baseRandom":"node_modules/lodash/_baseRandom.js","./_isIterateeCall":"node_modules/lodash/_isIterateeCall.js","./toFinite":"node_modules/lodash/toFinite.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var scene = (0, _svg.default)("app").size(300, 300);
var group = scene.group();
group.x(150);
group.y(300);
group.rotate(180);

var drawBranch = function drawBranch(startX, startY, len, branchWidth, angle) {
  group.path("M ".concat(startX, " ").concat(startY, " Q ").concat(startX + (0, _random.default)(-8, 8), " ").concat(startY + len * (0, _random.default)(0.1, 0.9), " ").concat(startX, " ").concat(startY + len)).stroke({
    color: "#0E5C22",
    width: branchWidth,
    linecap: "round"
  }).fill({
  ...
  var endX = startX - len * 0.95 * Math.sin(theta);
  var endY = startY + len * 0.95 * Math.cos(theta);
  drawBranch(endX, endY, len * 0.8, branchWidth * 0.7, angle * 1.3 + (0, _random.default)(-8, -25));
  drawBranch(endX, endY, len * 0.8, branchWidth * 0.7, angle * 1.3 + (0, _random.default)(8, 25));
};

drawBranch(0, 10, 70, 12, 0);
},{"./styles.css":"src/styles.css","svg.js":"node_modules/svg.js/dist/svg.js","lodash/random":"node_modules/lodash/random.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
